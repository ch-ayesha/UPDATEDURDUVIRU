(this["webpackJsonppwa-demo"]=this["webpackJsonppwa-demo"]||[]).push([[16,32],{269:function(e,t,a){"use strict";a.d(t,"a",(function(){return x}));var n=a(12),r=a.n(n),c=a(74),o=a(343),s=a(223),i=a(215),p=a(210);var l=p.default.div`
...
`,h=p.default.div`
  margin-bottom: 16px;
`;var m=a(49);const b=Object(c.a)((e=>{let{container:t}=e;return a(285)(`./${t}`)}),{fallback:Object(m.jsx)("div",{children:"Loading ..."}),cacheKey:e=>{let{container:t}=e;return t}});const j=e=>{let{steps:t,children:a}=e;const n=Object(s.i)(),c=Object(s.h)(),[p,j]=r.a.useState(!1),x=r.a.useMemo((()=>{const e=n.url.replace(/\/$/,"");return t.map((t=>e+t.path))}),[n.url,t]);return r.a.useEffect((()=>{j(!0)}),[]),Object(m.jsx)(i.a,{children:Object(m.jsxs)(d,{children:[Object(m.jsx)(u,{children:p&&Object(m.jsx)(o.a,{location:c,timing:"ease-in-out",duration:500,pathList:x,children:t.map((e=>Object(m.jsx)(s.b,{exact:!0,path:Array.isArray(e.path)?e.path.map((e=>n.path+e)):n.path+e.path,render:()=>Object(m.jsx)(l,{children:Object(m.jsx)(b,{container:e.componentPath,...e.props})})},e.componentPath)))})}),Object(m.jsx)(h,{id:"wizard-buttons",children:a})]})})};var x=r.a.memo(j)},307:function(e,t,a){"use strict";a.r(t);var n=a(12),r=a.n(n),c=a(215),o=a(223),s=a(269),i=a(210);const p=i.default.ul`
  display: flex;
