(this["webpackJsonppwa-demo"]=this["webpackJsonppwa-demo"]||[]).push([[4,27],{222:function(e,t,n){"use strict";n.d(t,"b",(function(){return r})),n.d(t,"a",(function(){return s}));var i=n(210),o=n(213);const a=i.css`
...
`,s=i.default.div`
  ...
  line-height: 1;
  color: ${o.a.darkBlack};
`},227:function(e,t,n){"use strict";n.d(t,"a",(function(){return d}));var i=n(12),o=n.n(i),a=n(210),r=n(213);const s=a.default.button`
  height: 52px;
  border-radius: 15px; 
...
`;var c=n(49);var d=o.a.memo((e=>{let{children:t,...n}=e;return Object(c.jsx)(s,{type:"button",...n,children:t})}))},230:function(e,t,n){"use strict";n.d(t,"a",(function(){return d}));var i=n(12),o=n.n(i),a=n(227);const r=n(210).default.div`
  display: flex;
  align-items: center;
...
`,k=C.default.div`
  ...
  margin-top: 10px;
  margin-bottom: 30px;
`;var S=n(49);y.a.setAppElement("#root");var N=o.a.memo((e=>{let{modalTitle:t,children:n,onConfirm:i,...o}=e;const{t:a}=Object(s.a)();return Object(S.jsx)(y.a,{...o,style:{content:{height:"281px",maxWidth:"348px",margin:"auto",borderRadius:"10px",border:"none"},overlay:{backgroundColor:"rgba(0, 0, 0, 0.5)"}},children:Object(S.jsxs)(w,{className:"ModalBody",children:[Object(S.jsx)(R,{children:t}),Object(S.jsx)(k,{children:n}),Object(S.jsx)(j.a,{onClick:i,dark:!0,children:a("recordingsIntroduction:retryButton","Retry")})]})})})),E=n.p+"static/media/start.e0d4d3a6.svg",O=n(328),A=n(213);const M=C.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,p=i.default.img.attrs((()=>({src:r.a})))`
  ...
  height: 10px;
  margin: 0px 2px 4px;
`},385:function(e,t,n){"use strict";t.a={sizeAsHuman:(e,t)=>{const n=t?1e3:1024;if(Math.abs(e)<n)return`${e} B`;const i=t?["kB","MB","GB","TB","PB","EB","ZB","YB"]:["KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"];let o=-1;do{e/=n,++o}while(Math.abs(e)>=n&&o<i.length-1);return`${e.toFixed(1)} ${i[o]}`},blobToFile:(e,t)=>{const n=e;return n.lastModifiedDate=new Date,n.name=t,e}}},386:function(e,t,n){"use strict";n.d(t,"a",(function(){return o}));var i=n(466);function o(e,t){return new Promise((n=>{e.duration===1/0||i.isSafari&&!(i.isSafari&&e.duration>0)?(e.addEventListener("durationchange",(()=>{t?e.remove():(e.pause(),e.volume=1,e.currentTime=0),n(e.duration)})),e.currentTime=86400,e.play()):n(e.duration)}))}}}]);
//# sourceMappingURL=4.9749f517.chunk.js.map